...
class Reader
{
    ...
    public function __construct($class, $variable = null, $type='method')
    {
        ...
        if (is_null($variable)) {
            ...
            if ($type === "method") {
                $reflection = new \ReflectionMethod($class, $variable);
            } else if ($type === "property") {
                $reflection = new \ReflectionProperty($class, $variable);
            }
        }
